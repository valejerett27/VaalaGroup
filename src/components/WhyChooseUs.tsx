      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
            ¿Por Qué Elegir
            <span className="bg-gradient-to-r from-cyan-600 to-blue-600 bg-clip-text text-transparent"> Vaala Group</span>?
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {reasons.map((reason, index) => (
            ...
            >
              <div className="bg-gradient-to-br from-cyan-100 to-blue-100 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                <reason.icon className="text-cyan-600" size={28} />
              </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-cyan-600 to-blue-600 rounded-3xl p-8 lg:p-12 text-center text-white">
          ...
          <button className="bg-white text-cyan-600 px-8 py-4 rounded-full font-bold text-lg hover:shadow-lg hover:scale-105 transition-all duration-300">
